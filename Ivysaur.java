...
public class Ivysaur extends Creature
{
    ...
    /**
     * attackAnimation will animate ivysaur by setting the location of it's image to a certain point
     * 
     * @param no parameters
     * @return nothing is returned
     */
    ...
    /**
     * switchedIn will move ivysaur in to a specific point in the world if the user
