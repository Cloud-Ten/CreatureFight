...
public class Lapras extends Creature
{
    ...
    /**
     * attackAnimation will animate lapras by setting the location of it's image to a certain point
     * 
     * @param no parameters
     * @return nothing is returned
     */
    ...
    /**
     * switchedIn will move lapras in to a specific point in the world if the user
