...
public class Pikachu extends Creature
{
    ...
    /**
     * attackAnimation will animate pikachu by setting the location of it's image to a certain point
     * 
     * @param no parameters
     * @return nothing is returned
     */
    ...
    /**
     * switchedIn will move pikachu in to a specific point in the world if the user
